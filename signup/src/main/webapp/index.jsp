...
<body id="page-top">
	...
	<nav
		...
		id="mainNav">
		<div class="container">
			<a class="navbar-brand" href="#page-top">student Admission</a>
			<button
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ms-auto">
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="#contact">Application</a></li>
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="logout">Logout</a></li>
					<li class="nav-item mx-0 mx-lg-1 bg-dadnger"><a
	...
	<section class="page-section" id="contact">
		<div class="container">
			...
			<h2
				class="page-section-heading text-center text-uppercase text-secondary mb-0">Application
				Credentials</h2>
			...
			<div class="row justify-content-center">
				<div class="col-lg-8 col-xl-7">
					...
					<form id="contactForm" data-sb-form-api-token="API_TOKEN">
						...
						<div class="form-floating mb-3">
							<label for="passport_picture"></label><br> <input
								class="form-control" id="passport_picture" type="file"
								accept=".jpg, .jpeg, .png" />
						</div>

						<div class="form-floating mb-3">
							<label for="certificates">Certificates (PDF)</label><br> <input
								class="form-control" id="certificates" type="file" accept=".pdf" />
						</div>
	...
	<div class="copyright py-4 text-center text-white">
		<div class="container">
			<small>Copyright &copy; admission 2024</small>
		</div>
	</div>
	...
	<div class="portfolio-modal modal fade" id="portfolioModal1"
		...
		<div class="modal-dialog modal-xl">
			<div class="modal-content">
				...
				<div class="modal-body text-center pb-5"></div>
			</div>
		</div>
	</div>
